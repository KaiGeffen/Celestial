...
export const achievementsMeta: Record<number, AchievementMeta> = {
  ...
  7: {
    title: 'Game Night',
    description: 'Play a PVP game any Wednesday night between 7-9PM EST.',
    image: 'border-Thorns',
    borderUnlock: 1,
  },
  8: {
  ...
  1007: {
    title: 'Vision Border',
    description: 'A special gift for the holidays!',
    image: 'border-Vision',
    borderUnlock: 7,
  },
  1008: {
    title: 'Water Border',
    description: 'A prize for the 200th Discord member!',
    image: 'border-Water',
    borderUnlock: 8,
  },
  1009: {
