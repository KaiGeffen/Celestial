...
export const JOURNEY_MISSIONS: JourneyMissionTracks = [
  ...
  [
    ...
    },
    {
      ...
      deck: [23, 18, 15, 11, 34, 9, 9, 33, 0, 0],
    ...
    {
      selectText: 'Bonus: Bounty',
      missionText: `With a companion by my side, the world becomes richer. Every hunt is more successful, every meal more satisfying. The bounty of life is greater when shared.`,
      uponRoundWinText: [
