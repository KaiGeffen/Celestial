export default `I decide to take the bus to the cemetery. The crowd on board resembles what I can recall from my high school commute, all appearing to be locals. I turn my focus to the window for the rest of the ride. A sudden spring shower starts, dotting my view with rolling droplets. There aren’t any landscaped planter boxes, but the sidewalks look a bit cleaner, brighter somehow. Though, that could just be a projection of what I want to see.
